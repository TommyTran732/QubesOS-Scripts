...
sudo dnf remove thunderbird totem gnome-remote-desktop gnome-calendar gnome-calculators gnome-weather gnome-contacts gnome-clocks gnome-maps gnome-screenshot gnome-logs gnome-character gnome-font-viewer gnome-color-manager simple-scan keepassxc cheese baobab yelp -y
...
sudo dnf install brave-browser yubikey-manager-qt yubiauth-desktop -y
