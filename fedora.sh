...
sudo dnf remove thunderbird gnome-remote-desktop gnome-calendar gnome-calculator gnome-weather gnome-contacts gnome-clock gnome-maps keepassxc geditcheese firefox baobab  -y
